...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FlagUser'
        db.create_table(u'waffle_flaguser', (
    ...
    models = {
        ...
        u'waffle.flag': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'symmetrical': 'False', 'through': u"orm['waffle.FlagUser']", 'blank': 'True'})
        },
        u'waffle.flaguser': {
            'Meta': {'object_name': 'FlagUser'},
